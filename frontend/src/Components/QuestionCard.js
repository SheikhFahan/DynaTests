...
const QuestionCard = () => {
   ...
   const handleEasyAnswers = (questionId, choiceId) => {
        setAnswersForEasy((prevAnswers) => {
            const existingAnswerIndex = prevAnswers['easy'].findIndex(answer => answer.question_id === questionId);
            if(existingAnswerIndex !== -1){
                ...
                return { ...prevAnswers, easy: [...prevAnswers['easy'], { question_id: questionId, answer_id: choiceId }] };
            }
        });
      };
      const handleMediumAnswers = (questionId, choiceId) => {
        setAnswersForMedium((prevAnswers) => {
            const existingAnswerIndex = prevAnswers['medium'].findIndex(answer => answer.question_id === questionId);
            if(existingAnswerIndex !== -1){
                ...
                return { ...prevAnswers, medium: [...prevAnswers['medium'], { question_id: questionId, answer_id: choiceId }] };
            }
        });
      };
      const handleHardAnswers = (questionId, choiceId) => {
        setAnswersForHard((prevAnswers) => {
            const existingAnswerIndex = prevAnswers['hard'].findIndex(answer => answer.question_id === questionId);
            if(existingAnswerIndex !== -1){
                ...
                return { ...prevAnswers, hard: [...prevAnswers['hard'], { question_id: questionId, answer_id: choiceId }] };
            }
        });
      };
